//
//  AnswerRoomMsgListTableViewCell.m
//  TXLiteAVDemo
//
...
@implementation AnswerRoomMsgModel

@end


@implementation AnswerRoomMsgListTableViewCell
{
    UIView             *_msgView;
    UILabel            *_msgLabel;
    
    AnswerRoomMsgModeType     _msgModeType;
}
...
- (void)layoutSubviews {
    ...
    if (_msgModeType == AnswerRoomMsgModeTypeOneself) {
...
+ (NSAttributedString *)getAttributedStringFromModel:(AnswerRoomMsgModel *)msgModel {
    ...
    // 系统消息
    if (msgModel.type == AnswerRoomMsgModeTypeSystem) {
    ...
    UIColor *color = nil;
    if (msgModel.type == AnswerRoomMsgModeTypeOneself) {
