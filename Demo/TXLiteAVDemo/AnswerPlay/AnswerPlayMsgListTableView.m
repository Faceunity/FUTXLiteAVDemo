...
@implementation AnswerPlayMsgListTableView
{
...
- (void)appendMsg:(AnswerPlayMsgModel *)msgModel {
    ...
    msgModel.attributedMsgText = [AnswerPlayMsgListTableViewCell getAttributedStringFromModel:msgModel];
...
- (CGFloat)calculateTotalCellHeight {
    ...
    for (AnswerPlayMsgModel *model in _msgArray) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row < _msgArray.count) {
        AnswerPlayMsgModel *msgModel = _msgArray[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AnswerPlayMsgListTableViewCell *cell = (AnswerPlayMsgListTableViewCell *)[self dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[AnswerPlayMsgListTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
