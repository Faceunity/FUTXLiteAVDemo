...
@implementation AnswerRoomMsgListTableView
{
...
- (void)appendMsg:(AnswerRoomMsgModel *)msgModel {
    ...
    msgModel.attributedMsgText = [AnswerRoomMsgListTableViewCell getAttributedStringFromModel:msgModel];
...
- (CGFloat)calculateTotalCellHeight {
    ...
    for (AnswerRoomMsgModel *model in _msgArray) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row < _msgArray.count) {
        AnswerRoomMsgModel *msgModel = _msgArray[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AnswerRoomMsgListTableViewCell *cell = (AnswerRoomMsgListTableViewCell *)[self dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[AnswerRoomMsgListTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
